<template>
     <header class="header">
       ...
       <!--Logo-->
       <a href="#" class="logo"><img src= "@/assets/images/logo.png" alt="logotipo"></a>
       <!--Menu NAV-->
       <span class="menu-icon">Ver menú</span>
       <nav class="menu">
        <ul>
           <li><router-link to="/">Home</router-link></li>
           <li><a href="#horarios-ubicacion">Horario</a></li>
            <li><a href="#entrenadores">Entrenadores</a></li>
            <li><a v-b-modal.modal-inscripcion>Inscripción</a></li>
...
.header{
    background: rgb(121, 152, 182);
    top: 0;
    left: 0;
    right: 0;
    padding: 1rem 0;
    opacity: 1;
    border-top: 5px solid #122350;
    box-shadow: 3px 3px rgba(156, 155, 224, 0.384), -1em 0 0.4em olive;
    position: fixed; 
