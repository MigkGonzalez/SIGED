<template>
  <div class = 'container'>
    ...
    <form @submit.prevent = "editarinscripcion(inscripcionEditar)" v-if = "editar">
        ...
        <input type = "text" class = "form-control my-2" placeholder = "Nombres" v-model = "inscripcionEditar.nombre">

        <input type = "text" class = "form-control my-2" placeholder = "Apellidos" v-model = "inscripcionEditar.apellido">
    ...
    <form @submit.prevent = "agregarinscripcion()"  v-if = "!editar">
      ...
      <b-form-group id="direcRes" label="Direccion de residencia:">
        ...
        <input type = "date" class = "form-control my-2" placeholder = "Fecha de Nacimiento - Año" v-model = "inscripcion.fecha_nacimiento">
